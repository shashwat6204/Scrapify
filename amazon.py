...
def get_amazon_product_info(url):
    ...
    if response.status_code == 200:
        ...
        product_name_element = soup.select_one('#productTitle')  # Adjust the selector as needed
        product_rating_element = soup.select_one('span.a-icon-alt')  # Adjust the selector as needed
        product_price_element = soup.select_one('span.a-price-whole')  # Adjust the selector as needed
